...
pub const ILLEGAL___ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{4}) {
        cpu.mode = .illegal;
        return .{};
    }
};

pub const nop_______ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{4}) {
        return .{};
    }
};

pub const sys__mo___ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{4}) {
        cpu.mode = op.arg0.mo;
        return .{};
    }
...
pub const scf_______ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{4}) {
        return .{};
    }

    pub fn flags(curr: u16, last: u16, pref: Flags) Flags {
        return .{
            .Z = pref.Z,
            .N = false,
            .H = 0,
...
pub const daa__rb___ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op, pref: Flags) Result(1, .{4}) {
        ...
        if (pref.N) {
            ...
            // ADD -> DAA
            if (pref.H == 1 or (val >> 0 & 0xF) > 0x9) {
                carry |= @boolToInt(@addWithOverflow(u8, val, 0x6, &val));
            }

            if (carry == 1 or (val >> 4 & 0xF) > 0x9) {
                carry |= @boolToInt(@addWithOverflow(u8, val, 0x60, &val));
            }
        }
    ...
    pub fn flags(curr: u16, last: u16, pref: Flags) Flags {
        return .{
            ...
            .N = pref.N,
            .H = 0,
            .C = pref.C | @boolToInt(!pref.N and curr < last),
        };
    }
};

pub const jr___IB___ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(2, .{12}) {
...
pub const jr___zc_IB = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(2, .{ 8, 12 }) {
...
pub const jp___IW___ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(3, .{16}) {
        cpu.reg._16.set(.PC, op.arg0.iw);
        return .{};
    }
};

pub const jp___zc_IW = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(3, .{ 12, 16 }) {
        if (op.arg0.zc.check(cpu.*)) {
...
pub const ret_______ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{16}) {
...
pub const ret__zc___ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{ 8, 20 }) {
        if (op.arg0.zc.check(cpu.*)) {
            const jump = pop16(cpu, mmu);
            cpu.reg._16.set(.PC, jump);
            return .{ .duration = 20 };
...
pub const call_IW___ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(3, .{24}) {
        push16(cpu, mmu, cpu.reg._16.get(.PC));
        cpu.reg._16.set(.PC, op.arg0.iw);
        return .{};
    }
...
pub const call_zc_IW = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(3, .{ 12, 24 }) {
        if (op.arg0.zc.check(cpu.*)) {
            push16(cpu, mmu, cpu.reg._16.get(.PC));
            cpu.reg._16.set(.PC, op.arg1.iw);
            return .{ .duration = 24 };
...
pub const ld___rb_ib = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(2, .{8}) {
        cpu.reg._8.set(op.arg0.rb, op.arg1.ib);
        return .{};
    }
};

pub const ld___rb_rb = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{4}) {
...
pub const ld___rb_RB = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{8}) {
...
pub const ld___rw_iw = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(3, .{12}) {
        cpu.reg._16.set(op.arg0.rw, op.arg1.iw);
        return .{};
    }
};

pub const ld___RW_rb = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{8}) {
...
pub const ld___IW_rw = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(3, .{20}) {
...
pub const ldhl_rw_ib = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(2, .{16}) {
...
pub const inc__RW___ = struct {
    pub fn exec(cpu: *main.Cpu, mmu: *main.Mmu, op: Op) Result(1, .{12}) {
        const addr = cpu.reg._16.get(op.arg0.rw);
